...
\lstnewenvironment{poutput}{
 \lstset{caption=Output, language=,aboveskip=-3pt}
...
%\newenvironment{capfig}[3]{\begin{figure}[h!]\centering\includegraphics[width=#1]{#2}\caption{#3}\end{figure}}{}
...
\newenvironment{checkpointMC}[1]{\refstepcounter{ncheckpoint}%
    ...
    \begin{enumerate}[label=\Alph*),topsep=-10pt]}%  ithmdframed[skipabove=10pt,linewidth=2pt, backgroundcolor=green!10, roundcorner=10pt,nobreak=true]{checkpointSA}
...
\include{Chapter_Python}
\include{Chapter_Uncertainties}
\include{Chapter_ErrorPropagation}
\include{Chapter_Statistics_Data}
\include{Chapter_Statistics_Distributions}
\include{Chapter_Statistics_Gauss}
\include{Chapter_Statistics_ModelData}
\include{Chapter_Statistics_Probability}
\include{Chapter_Statistics_MonteCarlo}
