...
\end{align}
\capfig{0.7\textwidth}{figures/normaldist.png}{\label{fig:normaldist} Normal distribution for different parameters.}
...
\hline
\end{tabular}
\captionof{table}{\label{tab:normsigma}Probability that a normally distributed measurement will fall within a certain number, $n$, of standard deviations from the mean.}
\end{center}
\capfig{0.7\textwidth}{figures/gaus_sigmas.png}{\label{fig:gaus_sigmas} Illustration of the area under the normal distribution within 1, 2, and 3 standard deviations from the mean.}
...
\capfig{0.7\textwidth}{figures/normal_pdfcdfsf.png}{\label{fig:normal_pdfcdfsfl} Normal probability density function (pdf), cumulative probability density function (cdf) and survival fraction (sf).}
\clearpage
...
\hline
\end{tabular}
\captionof{table}{\label{tab:twoerrors}Ways to obtain different results when 2 random errors contribute.}
\end{center}
...
\capfig{0.7\textwidth}{figures/normal_ctl.png}{\label{fig:normal_ctl} Simulated histogram of final marks from 100 students in a course.} 
